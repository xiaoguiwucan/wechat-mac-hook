...
type WechatMessage struct {
	...
	// VoiceTranscript marks a synthetic event generated by the UI-layer hook when
	// WeChat displays its built-in voice-to-text result.  The AI service persists
	// it into the matching record media item but will not auto-reply to it.
	VoiceTranscript     bool   `json:"voice_transcript,omitempty"`
	VoiceTranscriptText string `json:"voice_transcript_text,omitempty"`
	VoiceMessageId      string `json:"voice_message_id,omitempty"`
}
...
type Config struct {
	...
	MediaProbeEnabled         bool   `json:"media_probe_enabled"`
	MediaProbeTarget          string `json:"media_probe_target"`
	MediaProbeIntervalSeconds int    `json:"media_probe_interval_seconds"`
	MediaProbeCooldownSeconds int    `json:"media_probe_cooldown_seconds"`
	MediaProbeTimeoutSeconds  int    `json:"media_probe_timeout_seconds"`
