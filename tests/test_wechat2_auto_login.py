...
from web_admin.server import classify_wechat2_login_snapshot, normalize_auto_login_config


class WeChat2AutoLoginTests(unittest.TestCase):
    def test_logged_in_marker_always_blocks_click_candidate(self):
        result = classify_wechat2_login_snapshot([
    ...
    def test_non_exact_or_busy_window_is_never_candidate(self):
        self.assertEqual(classify_wechat2_login_snapshot([
        ...
        self.assertEqual(classify_wechat2_login_snapshot(busy)["status"], "watching")
